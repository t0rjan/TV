$(function ($) {
    var grid_selector = "#label-grid-table";
    var pager_selector = "#label-grid-pager";
    var token = $('#label_token').val();
    ...
    $(grid_selector).jqGrid({
        ...
        height: 550,
        colNames: [' ', 'ID', '标签名称', '创建用户', '创建时间', '更新时间', '状态'],
        colModel: [
            {
        ...
        editurl: "/anonymous/label/oper",//nothing is saved
        multiselect: true,
        caption: "标签列表",
        autowidth: true
